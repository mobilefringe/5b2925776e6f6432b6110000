...
require(['Vue', 'vuex', 'vue2-filters', 'vue_router', 'routes', 'vuex-router-sync', 'datastore', 'vue-i18n', 'locales', 'moment', 'vue-meta', 'vue!loading.vue', 'vue!messages.vue', 'vue!header.vue', 'vue!footer.vue', 'vue!inside_header.vue', 'json!menu_items.json'], function (Vue, Vuex, Vue2Filters, VueRouter, appRoutes, VuexRouterSync, store, VueI18n, messages, moment, Meta, LoadingComponent, MessagesComponent, HeaderComponent, FooterComponent, insideHeaderComponent, MenuItems) {
        ...
        created: function ()  {
            this.loadData().then(response => {
                ...
                this.property.default_logo_url = "//codecloud.cdn.speedyrails.net/sites/5b2925776e6f6432b6110000/image/png/1529701995203/default_logo_600.png";               
                 var inside_banner = this.findRepoByName('SVG Map');
        ...
        methods: {
            loadData: async function() {
                try{
                    ...
                    await this.$store.dispatch("property");
